...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDTO createOrder(OrderDTO dto) throws UserException {
        ...
        // Fallback: nếu cashier chưa được gán branch trong DB,
        // thử dùng branchId từ DTO và tự fix data trong DB
        if (branch == null && dto.getBranchId() != null) {
        ...
        if (branch == null) {
            throw new UserException(
                "Cashier has no branch assigned. Please contact your manager to assign this cashier to a branch."
            );
        }
