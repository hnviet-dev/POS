            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p>
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${selectedTransaction.status === "Sale"
                ...
                <div>
                  ...
                  <p
                    className={`font-bold ${selectedTransaction.totalAmount > 0
                        ? "text-green-600"
                        : "text-red-600"
                      }`}
                  >
